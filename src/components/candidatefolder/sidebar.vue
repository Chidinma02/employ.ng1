<template>
  <div class="user-sidebar gt">
    <div class="sidebar-inner">
      <ul class="navigation">
        <li class="active" @click="link()">
        ...
        <li>
          <a href="candidate-dashboard-resume.html"
            ><i class="la la-file-invoice"></i>My Resume</a
          >
        </li>
        <li>
        ...
        <li>
          <a href="candidate-dashboard-job-alerts.html"
            ><i class="la la-bell"></i>Job Alerts</a
          >
        </li>
        <li>
        ...
        <li>
          <a href="candidate-dashboard-cv-manager.html"
            ><i class="la la-file-invoice"></i> CV manager</a
          >
        </li>
        <li>
          <a href="dashboard-packages.html"
            ><i class="la la-box"></i>Packages</a
          >
        </li>
        <li>
          <a href="dashboard-messages.html"
            ><i class="la la-comment-o"></i>Messages</a
          >
        </li>
        <li>
        ...
        <li>
          <a href="dashboard-profile.html"
            ><i class="la la-user-alt"></i>View Profile</a
          >
        </li>
        <li>
          <a href="index.html"><i class="la la-sign-out"></i>Logout</a>
        </li>
        <li>
