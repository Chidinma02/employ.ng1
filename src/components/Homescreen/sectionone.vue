      ...
      <div class="row">
        <div class="content-column col-lg-7 col-md-12 col-sm-12">
          <div class="inner-column wow fadeInUp" data-wow-delay="1000ms">
            <div class="title-box">
              <h3>
                There Are <span class="colored">93,178</span> Postings Here<br />
                For you!
              </h3>
              <div class="text">
        ...
        <div class="image-column col-lg-5 col-md-12">
          <div class="image-box">
            ...
            <!-- Info BLock One -->
            <div
              class="info_block anm wow fadeIn"
            ...
            <!-- Info BLock Two -->
            <div
              class="info_block_two anm wow fadeIn"
            ...
            <!-- Info BLock Three -->
            <div
              class="info_block_three anm wow fadeIn"
            ...
            <!-- Info BLock Four -->
            <div
              class="info_block_four anm wow fadeIn"
